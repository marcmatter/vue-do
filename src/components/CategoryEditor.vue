<template>
  <div class="absolute top-0 left-0 z-10 h-full w-full bg-black bg-opacity-50">
    <div class="fixed top-0 left-0 flex h-full w-full items-center justify-center">
      <div class="min-w-[36rem] rounded-xl bg-zinc-800 p-8">
        <div class="flex">
        ...
        >
          <template #item="{ element }">
            <div :key="element.id" class="flex select-none items-center p-2">
              ...
              <div class="popup-container relative py-2">
                <BaseIcon
                  ...
                  "
                  class="mx-2 h-6 w-6 shrink-0 text-zinc-400 hover:text-white"
                />
                <div
